...
| --- | ---: | ---: |
| Skills / เส้นทาง Router | 49 / 48 | 49 / 48 |
| Routing regression | 81 เคส | 93 เคส |
...
- ยังถามกลับเหมือนเดิมเมื่อคำขอไม่บอกงาน ("ช่วยดูเอกสารนี้หน่อย"), ถามเรื่องเอกสารที่ต้องแนบ, เป็นการอนุมัติหรือส่งแบบฟอร์ม หรือเอ่ยถึงทีม/ระเบียบ/แบบฟอร์ม/ระบบของ STeP และ Authority BLOCK ยังมาก่อนทุกกรณี
