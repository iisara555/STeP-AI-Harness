...
**เมื่อมี NC หรือข้อร้องเรียนหลายรายการ ให้จัดลำดับด้วย Pareto ก่อนเลือกเรื่องที่จะทำ CAPA** (จัดลำดับสาเหตุจากมากไปน้อย แล้วดูว่ากลุ่มบนสุดรวมกันเป็นสัดส่วนเท่าไร):

1. **เลือกหน่วยนับให้ตรงกับผลกระทบ** — จำนวนครั้ง จำนวนวันที่ล่าช้า หรือจำนวนเงิน แล้วบอกเหตุผล ถ้าไม่แน่ใจให้แสดงจำนวนครั้งคู่กับผลกระทบ เพราะเรื่องที่เกิดบ่อยอาจไม่ใช่เรื่องที่เสียหายมากที่สุด
2. **จัดหมวดให้สะอาดก่อนนับ** — ทุกหมวดต้องละเอียดระดับเดียวกัน ไม่ปนอาการ ("ล่าช้า") กับสาเหตุ ("เอกสารไม่ครบ") รวมคำที่หมายถึงสิ่งเดียวกันและบอกว่ารวมอะไรบ้าง ถ้า "อื่น ๆ" เกินราว 15% ให้แยกหมวดใหม่ก่อน
3. **เทียบกับปริมาณงาน** — ถ้าเทียบข้ามทีม บริการ หรือช่วงเวลา ให้หารด้วยจำนวนงานหรือจำนวนคำขอ และบอกฐานที่ใช้ ทีมที่รับงานมากจะดูแย่เสมอถ้านับดิบ
4. **ตรวจว่าอันดับคงที่** — เทียบอย่างน้อย 2 ช่วงเวลา หมวดที่อยู่อันดับต้นทั้งสองช่วงจึงคุ้มลงแรง ช่วงเดียวคือเหตุการณ์เฉพาะ
5. **เจาะหมวดอันดับ 1 ลงอีกชั้น** — สาเหตุที่แก้ได้มักอยู่ใต้หมวดใหญ่หนึ่งชั้น แล้วเข้าขั้น RCA ด้านบน
6. **กำหนดตัวเลขที่ต้องขยับ** — ตัวเลขใด ควรลดเท่าไร และวัดซ้ำเมื่อไร ใช้เป็นเกณฑ์ใน Effectiveness Check

ผลลัพธ์ต้องเป็นตาราง หมวด | ผลกระทบ | สัดส่วน | สัดส่วนสะสม พร้อมหมายเหตุข้อมูล: หมวดที่รวม แถวที่ตัดออก และสัดส่วน "อื่น ๆ" กราฟเป็นทางเลือก ตารางต้องมีเสมอ ถ้าข้อมูลน้อยเกินจะจัดลำดับให้เชื่อถือได้ ให้บอกตรง ๆ
...
- Pareto (เมื่อมีหลายรายการ) พร้อมหมายเหตุข้อมูล
