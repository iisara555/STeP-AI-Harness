...
/**
 * Generate GEMINI.md content optimized for Gemini CLI / Google Antigravity
 * @param {object} role 
 * @param {Array<{relativePath: string, type: string}>} files 
 * @returns {string}
 */
export function generateGeminiInstructions(role, files) {
  let text = `# Gemini CLI / Google Antigravity — STeP AI Context & Instructions\n\n`;
  ...
  text += `**Accounts:** ใช้ได้ทั้งบัญชีฟรีและบัญชีเสียเงิน รวมบัญชี Google ที่ได้สิทธิ์นักศึกษา (Gemini CLI / Google Antigravity)\n`;
  ...
  text += `\n## Gemini CLI / Antigravity Execution Directives\n`;
