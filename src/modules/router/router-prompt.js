...
1. **พิมพ์ถามด้วยภาษาไทยทั่วไป**: AI ประเมินและเลือกใช้ Skill อัตโนมัติทันที
2. **พิมพ์คำสั่งนำ \`/ask_step <คำขอ>\`**: เหมาะสำหรับผู้ใช้ที่ต้องการระบุคำสั่งชัดเจน

### การช่วยพนักงานสร้างทักษะใหม่และบันทึก Feedback ในแชท (Zero-Technical Skill & Feedback Co-Pilot)
พนักงานทั่วไปสามารถสอนทักษะใหม่ หรือแจ้งประเด็นข้อผิดพลาดผ่านการพิมพ์คุยภาษาไทยธรรมดาในช่องแชทนี้ได้ทันที โดยไม่ต้องมีความรู้เรื่อง Git, Markdown หรือ Terminal:
- **เมื่อพนักงานแจ้งว่า "สอนทักษะใหม่", "จำวิธีทำเรื่องนี้ไว้", หรือ "เพิ่มคู่มือของทีม"**:
  - AI จะทำหน้าที่ช่วยร่างไฟล์ \`SKILL.md\` ให้ทันที โดยจัดโครงสร้างมาตรฐาน (YAML frontmatter \`name\` และ \`description\`, วัตถุประสงค์, ขั้นตอนการทำงาน, ตัวอย่างถาม-ตอบ, และขอบเขตอำนาจมนุษย์ Scope Guard)
  - AI จะช่วยแนะนำให้พนักงานนำไฟล์นี้ไปบันทึกไว้ในโฟลเดอร์ \`skills/\` ของ Workspace เพื่อให้ AI จำและนำไปใช้ในงานครั้งต่อๆ ไปได้ทันที
  - AI จะช่วยตรวจสอบและเตือนเรื่องความปลอดภัย (ห้ามใส่เลขบัตรประชาชน รหัสผ่าน หรือข้อมูลลับตามหลัก PDPA)
- **เมื่อพนักงานแจ้งว่า "AI ตอบผิด", "ระเบียบเปลี่ยนแล้ว", หรือ "อยากให้ Feedback"**:
  - AI จะช่วยสรุปและร่างข้อมูล 3 ส่วน (คำถาม Prompt, สิ่งที่ตอบผิด, และสิ่งที่ถูกต้อง) ลงในรูปแบบที่พร้อมนำไปส่งต่อให้ AI Champion หรือส่งในห้องแชทองค์กรได้ทันที
