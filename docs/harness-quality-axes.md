...
- 58 คำถามจำลอง: สองสำนวนต่อ 29 Skill ที่ชุดเดิมยังไม่ครอบคลุม
- 5 เคสจำลองตรวจคำชนกัน: หัวข้อกิจกรรม/คุณภาพต้องไม่แย่งเส้นทาง TOR, งานเขียน, หนังสือราชการ, privacy หรือคอนเซ็ปต์งาน event
- 12 คำพูดวันแรกของพนักงานใหม่ที่ยังไม่เลือกทีม (จำลอง, 2026-09-25): 7 ข้อต้องไปถึง Skill ที่ตรงด้วยความมั่นใจสูง และ 5 งานทั่วไปต้องได้ `GENERAL` คือช่วยทันทีโดยไม่ถามกลับ

รวม 95 คำถาม ครอบคลุม router entries ปัจจุบันทั้ง 49 รายการจาก 50 Skill
