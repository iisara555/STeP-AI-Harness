...
- 54 คำถามจำลอง: สองสำนวนต่อ 27 Skill ที่ชุดเดิมยังไม่ครอบคลุม
- 4 เคสจำลองตรวจคำชนกัน: หัวข้อกิจกรรม/คุณภาพต้องไม่แย่งเส้นทาง TOR, งานเขียน, หนังสือราชการ หรือ privacy

รวม 78 คำถาม ครอบคลุม router entries ปัจจุบันทั้ง 45 รายการจาก 46 Skill
