...
ตั้งแต่ **Pilot v0.5** ไฟล์ `Update-STeP-AI.bat` (Windows) และ `Update-STeP-AI.command` (macOS) จะตรวจสอบ GitHub Releases ก่อนทุกครั้ง
...
> สำหรับผู้ใช้ **v0.3.0 หรือต่ำกว่า** ต้องดาวน์โหลด v0.5.0 ใหม่หนึ่งครั้ง เพราะ updater รุ่นเก่ายังไม่สามารถดึง Release ใหม่เองได้ หลังจาก v0.5.0 เป็นต้นไปสามารถใช้ไฟล์ Update เพื่ออัปเดตเวอร์ชันถัดไปได้
