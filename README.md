...
1. **ดาวน์โหลด:** นำไฟล์ `STeP-AI-Pilot-v0.1.0.zip` จาก Shared Drive ขององค์กรมาไว้ในเครื่อง แล้วแตกไฟล์ (Extract All บน Windows หรือดับเบิลคลิกบน Mac)
2. **ดับเบิลคลิกติดตั้ง:**
   - **บน Windows:** ดับเบิลคลิกที่ไฟล์ **`Install-STeP-AI.bat`**
   - **บน macOS:** ดับเบิลคลิกที่ไฟล์ **`Install-STeP-AI.command`** (หรือรัน `bash install/install-mac.sh`)
   - ระบบจะตรวจหาโปรแกรม AI (Codex/VS Code, Cursor, Claude Desktop) ในเครื่องให้อัตโนมัติ
...
3. **เสร็จสิ้นพร้อมใช้งาน:** ระบบจะแจ้งเตือน `✓ STeP AI พร้อมใช้งาน`
   ...
   - เมื่อองค์กรมีอัปเดตใหม่ เพียงดับเบิลคลิก **`Update-STeP-AI.bat`** (Windows) หรือ **`Update-STeP-AI.command`** (macOS)
